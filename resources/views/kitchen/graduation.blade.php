			...
			<form method="POST" action="/kitchen/graduation">
			    @csrf
					     ...
					     <div class="form-group ">
					  	...
					  	<div class="form-group ">
					                <label for="choice" class="col-sm-4 col-form-label">Type</label>
					            <div class="col-sm-12">
					...
					<div class="form-group " style="margin-top: 35px; ">
						...
						<div class="card-righta" style="margin-top: 88px; padding-right: 30px;">
							<h4>
								<a class="card-title">Graduation Cake</a>
							</h4>
							<p>
								You are Ordering a Graduation Cake
							</p>

							{{-- <a href="/graduation/ticket">Get your ticket</a> --}}
								<img src="/images/grad-cap.jpg" class="round" width="110" height="100"></img>
								
								<div style="margin-top: 10px;"><small>Contact: 0743-600-799</small> </div>
						</div>
